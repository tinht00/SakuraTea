...
public class TraLoiPhanHoiTest {
	 ...
	 @BeforeClass
	    ...
	    public void TC1() throws InterruptedException {
	        ...
	        WebElement traloi = driver.findElement(By.id("nntin20@gmail.com_Traloi"));
	        Thread.sleep(1000);
	        traloi.click();
	        
	        Thread.sleep(1000);
	        WebElement tieude = driver.findElement(By.id("nntin20@gmail.com_tieude"));
	        tieude.clear();
	        tieude.sendKeys("Tiêu đề");
	        
	        Thread.sleep(1000);
	        WebElement sodt = driver.findElement(By.id("nntin20@gmail.com_noidung"));
	        sodt.clear();
	        sodt.sendKeys("Nội dung");
	                
	        WebElement Submit = driver.findElement(By.id("nntin20@gmail.com_gui"));
	        Submit.click();
	    }
