					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form:form action="nguoidung/insert.htm"
										modelAttribute="nguoidung">

										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
												for="first-name">Họ và tên <span class="required">*</span>
											</label>
										...
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
												for="last-name">Xác nhận mật khẩu <span
												class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
												<form:password class="form-control" id="confirm_password"
													required="required" path="matkhau" />
											</div>
										</div>
										<br />
										<br />
										...
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
												for="last-name">Vai trò <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
												<form:select path="vaitro" class="form-control form-control">
										...
										<div class="form-group">
											<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
												<input type="submit" class="btn btn-round btn-danger"
													name="action" onclick="return Validate()" value="Submit">
												<input type="reset" class="btn btn-round btn-warning"
													value="Reset">
