...
<h3 align="center" style="padding: 20px">
	...
	<div class="container" style="max-width:60%">
		...
		<div class="form-group">
			...
			<div>
				<form:hidden path="hoten" value="${hoten}" />
			</div>
			<div>
				
				<input  style="display: none;" type="password"
						value="${matkhau}" id="password1"  />
			</div>
		...
		<div class="form-group">
			...
			<input type="password" class="input form-control"  required="required" placeholder="Nhập mật khẩu mới...."
					id="password" />
		</div>

		<div class="form-group">
			<label for="em">Nhập lại mật khẩu:</label>
			<form:input path="matkhau" type="password" class="input form-control"
					placeholder="Nhập lại mật khẩu...."	required="required" id="confirm_password" />
		</div>

			<div>

				<form:hidden path="sodt" value="${sodt}" />
			</div>
			<div>
			...
			<div>
				...
				<form:hidden path="diachi" value="${diachi}" />
			</div>
			<div>
...
<jsp:include page="../home/footer.jsp"></jsp:include></footer>
</body>
</html>