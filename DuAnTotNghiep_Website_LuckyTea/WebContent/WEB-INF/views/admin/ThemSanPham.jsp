...
<!-- bootstrap-wysiwyg -->
<link href="admin/vendors/google-code-prettify/bin/prettify.min.css"
	rel="stylesheet">
<!-- Select2 -->
<link href="admin/vendors/select2/dist/css/select2.min.css"
	rel="stylesheet">
<!-- Switchery -->
<link href="admin/vendors/switchery/dist/switchery.min.css"
	rel="stylesheet">
<!-- starrr -->
...
<body class="nav-md">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form:form action="sanpham/insert.htm" modelAttribute="sanpham">
										...
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
												for="last-name"> Tên Sản phẩm <span class="required">*</span>
											</label>
										...
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
												for="last-name">Hình <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
												<form:input id="CH" type="file" class="form-control"
													required="required" path="hinh" />
											</div>
										</div>
										<br />
										<br />
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12"
												for="last-name">Mã loại <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
												<form:select class="form-control" path="loaisanpham.maloai"
													items="${loaisanphams}" itemValue="maloai"
													itemLabel="tenloai" />
											</div>
										</div>
										<br />
										...
										<div class="form-group">
											<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
												<input type="submit" class="btn btn-round btn-danger"
													name="action" value="Submit"> <input type="reset"
	...
	<!-- jQuery autocomplete -->
	<script
		src="admin/admin/vendors/devbridge-autocomplete/dist/jquery.autocomplete.min.js"></script>
	<!-- starrr -->
